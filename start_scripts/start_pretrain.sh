...
--output_dir /apdcephfs/private_howardhwhou/video_search_product/saved_model/ALBEFResearch/ngramwise_loss_20220410 \
...
--config ./configs/Pretrain_commodity.yaml \
--output_dir /apdcephfs/private_howardhwhou/video_search_product/saved_model/ALBEFResearch/ngramwise_loss_20220410 \
--checkpoint /apdcephfs/private_howardhwhou/video_search_product/saved_model/ALBEFResearch/ngramwise_loss_20220410/checkpoint_10.pth \
--text_encoder /apdcephfs/private_howardhwhou/video_search_product/pretrained_model/bert-base-chinese/ \
--resume
...
--config ./configs/Pretrain_commodity.yaml \
--output_dir /apdcephfs/private_howardhwhou/video_search_product/saved_model/ALBEFResearch/ngramwise_loss_20220410 \
--checkpoint /apdcephfs/private_howardhwhou/video_search_product/saved_model/ALBEFResearch/ngramwise_loss_20220410/checkpoint_11.pth \
--text_encoder /apdcephfs/private_howardhwhou/video_search_product/pretrained_model/bert-base-chinese/ \
--resume
